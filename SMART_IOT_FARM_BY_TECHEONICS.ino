...
Smart ioTFarm 
git- https://github.com/gauravk5/ioT-Farm
...
String apiKey = "TJFBPV00XLHNV31O"; // Enter your Write API key from ThingSpeak
...
else if(soilmoisturepercent >=0 && soilmoisturepercent <= 100)
{
  ...
  else //if (soilmoisturepercent >30 && soilmoisturepercent <= 90)
  {
